...
</section>{tab!=="PLAY"&&<section className="tab-stage">{tab==="LOCKER ROOM"?<LockerRoom/>:tab==="LEADERBOARDS"?<LeaderboardModal/>:tab==="SETTINGS"?<SettingsModal/>:tab==="HORSES"?<CustomizationTabs mode="HORSES"/>:tab==="PLAYERS"?<CustomizationTabs mode="PLAYERS"/>:tab==="SHOP"?<ShopTab/>:<div className="customization"><small>{tab}</small><h1>{tab} COMING ONLINE</h1><p>This club service is connected to the main navigation hub.</p></div>}</section>}</main>}
