...
const tabs=["PLAY","LOCKER ROOM","HORSES","PLAYERS","CLUB","SHOP","CAREER","SETTINGS"],blue=["POLOPLAYER1 · No. 3","BlueNo2 · No. 1","StableMaster · No. 2","RoyalBack · No. 4"],red=["WolfOne · No. 1","WolfTwo · No. 2","WolfThree · No. 3","ScarletBack · No. 4"];
...
</section>{tab!=="PLAY"&&<section className="tab-stage">{tab==="LOCKER ROOM"?<LockerRoom/>:tab==="HORSES"?<CustomizationTabs mode="HORSES"/>:tab==="PLAYERS"?<CustomizationTabs mode="PLAYERS"/>:tab==="SHOP"?<ShopTab/>:<div className="customization"><small>{tab}</small><h1>{tab} COMING ONLINE</h1><p>This club service is connected to the main navigation hub.</p></div>}</section>}</main>}
