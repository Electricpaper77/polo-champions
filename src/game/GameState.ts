...
export function initializeMatchEntities(): Record<PoloRiderEntity["id"], PoloRiderEntity> {
  ...
  return { player:{...rider("player","blue","striker","ALL_ROUNDER",{x:-5,y:5},Math.PI/2),coat:loadout.coat,kitColor:kitColors[loadout.kit],mallet:loadout.mallet}, blue_2:rider("blue_2","blue","striker","SPRINTER",{x:-5,y:-15},Math.PI/2), blue_3:rider("blue_3","blue","striker","ALL_ROUNDER",{x:-5,y:-5},Math.PI/2), blue_4:rider("blue_4","blue","defender","POWER",{x:-5,y:15},Math.PI/2), red_1:rider("red_1","red","striker","SPRINTER",{x:5,y:-15},-Math.PI/2), red_2:rider("red_2","red","striker","ALL_ROUNDER",{x:5,y:-5},-Math.PI/2), red_3:rider("red_3","red","striker","SPRINTER",{x:5,y:5},-Math.PI/2), red_4:rider("red_4","red","defender","POWER",{x:5,y:15},-Math.PI/2) };
}
