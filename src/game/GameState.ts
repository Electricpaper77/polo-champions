...
export function initializeMatchEntities(): Record<PoloRiderEntity["id"], PoloRiderEntity> {
  ...
  return { player:{...rider("player","blue","striker","ALL_ROUNDER",{x:-8.5,y:15},Math.PI),coat:loadout.coat,kitColor:kitColors[loadout.kit],mallet:loadout.mallet}, blue_2:rider("blue_2","blue","striker","SPRINTER",{x:8.5,y:15},Math.PI), blue_3:rider("blue_3","blue","striker","ALL_ROUNDER",{x:-8.5,y:9},Math.PI), blue_4:rider("blue_4","blue","defender","POWER",{x:8.5,y:9},Math.PI), blue_5:rider("blue_5","blue","striker","SPRINTER",{x:-8.5,y:3},Math.PI), blue_6:rider("blue_6","blue","defender","POWER",{x:8.5,y:3},Math.PI), red_1:rider("red_1","red","striker","SPRINTER",{x:8.5,y:-15},0), red_2:rider("red_2","red","striker","ALL_ROUNDER",{x:-8.5,y:-15},0), red_3:rider("red_3","red","striker","SPRINTER",{x:8.5,y:-9},0), red_4:rider("red_4","red","defender","POWER",{x:-8.5,y:-9},0), red_5:rider("red_5","red","striker","ALL_ROUNDER",{x:8.5,y:-3},0), red_6:rider("red_6","red","defender","POWER",{x:-8.5,y:-3},0) };
}
